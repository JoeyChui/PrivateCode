...
# encoding: utf-8 
def text():
    f1 = open('C:\Users\zydn\Desktop\aaa\good','r',encoding='utf-8')
    f2 = open('C:\Users\zydn\Desktop\aaa\bad','r',encoding='utf-8')
    line1 = f1.readline()
    line2 = f2.readline()
    str = ''
    while line1:
...
def read_file(filename):
    ...
    stop = [line.strip() for line in  open('d:/stop.txt','r',encoding='utf-8').readlines()]#停用词
...
def jieba_feature(number):   
    ...
    for items in read_file('d:/good.txt'):#把集合的集合变成集合
  
        for item in items:
            posWords.append(item)
  
    for items in read_file('d:/bad.txt'):
...
def build_features():
    ...
    for items in read_file('d:/good.txt'):
